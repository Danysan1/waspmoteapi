...
const char str_wireach_67[] PROGMEM	= "EUSN"; 			// 67
const char str_wireach_68[] PROGMEM	= "EPSW"; 			// 68
const char str_wireach_69[] PROGMEM	= "CERT"; 			// 69
const char str_wireach_70[] PROGMEM	= "PKEY"; 			// 70
